...
public class DialogAlerta extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater,  ViewGroup container,  Bundle savedInstanceState) {
        ...
        TextView title = view.findViewById(R.id.textView_DialogAlerta_Title);
        TextView msg = view.findViewById(R.id.textView_DialogAlerta_MSG);
        Button button = view.findViewById(R.id.button_DialogAlerta_OK);
